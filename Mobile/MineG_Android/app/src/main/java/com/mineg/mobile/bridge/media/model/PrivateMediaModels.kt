/** Immutable private-media summaries, details, resources, views and save results. */
package com.mineg.mobile.bridge.media.model
...
interface OwnerMediaClient {
  /** Lists a bounded owner-media summary snapshot. */
