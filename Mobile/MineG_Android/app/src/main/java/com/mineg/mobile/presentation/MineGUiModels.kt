/** Immutable routes, screen state and UI-only projection models. */
...
sealed interface AppRoute {
  ...
  data class SharedMediaDetail(val mediaId: String) : AppRoute
...
/** Maps a selected bottom-navigation tab to its root application route. */
...
data class MineGAppState(
  ...
  val sharedMediaListScrollPosition: MediaListScrollPosition = MediaListScrollPosition(),
  ...
  val sharedAlbum: SharedAlbumUiState = SharedAlbumUiState(loadState = PageLoadState.EMPTY),
